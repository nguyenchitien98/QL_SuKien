...
//    tạo kết nối
//    static String sql = "jdbc:sqlserver://sql.freeasphost.net\\MSSQL2016;database=huynqph11019_PRO1_E2";
//    static String user = "huynqph11019";
//    static String pass = "Huydeptrai1@";
//    static String dri = "com.microsoft.sqlserver.jdbc.SQLServerDriver";
    static String sql = "jdbc:sqlserver://localhost\\SQLEXPRESS:1433;database=PRO1_E2";
